...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,063 | 🐛 171 | 🌐 Go | 📅 2026-05-19.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 834 | 🐛 30 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,984 | 🐛 69 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,099 | 🐛 5 | 📅 2026-05-16 - A curated list of awesome Helm charts and resources.
