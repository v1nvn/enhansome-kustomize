...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,057 | 🐛 170 | 🌐 Go | 📅 2026-05-19.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 831 | 🐛 29 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [PolicyGenerator](https://github.com/open-cluster-management-io/policy-generator-plugin) ⭐ 35 | 🐛 6 | 🌐 Go | 📅 2026-05-21 - Generating Open Cluster Management policies (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,949 | 🐛 59 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,098 | 🐛 4 | 📅 2026-05-16 - A curated list of awesome Helm charts and resources.
