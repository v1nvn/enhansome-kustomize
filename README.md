...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 11,922 | 🐛 186 | 🌐 Go | 📅 2026-02-05.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 798 | 🐛 32 | 🌐 Go | 📅 2025-11-24 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 37 | 🐛 3 | 🌐 Go | 📅 2026-02-07 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,799 | 🐛 73 | 🌐 Shell | 📅 2025-08-28 - A curated list of awesome Kubernetes resources.
