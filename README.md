...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,047 | 🐛 166 | 🌐 Go | 📅 2026-05-13.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 827 | 🐛 29 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-05-11 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,928 | 🐛 56 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
