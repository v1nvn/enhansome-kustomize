...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,020 | 🐛 174 | 🌐 Go | 📅 2026-04-08.
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-04-13 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,854 | 🐛 53 | 🌐 Shell | 📅 2026-02-27 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,097 | 🐛 10 | 📅 2025-05-23 - A curated list of awesome Helm charts and resources.
* [Awesome Kubectl plugins](https://github.com/ishantanu/awesome-kubectl-plugins) ⭐ 1,006 | 🐛 4 | 📅 2025-11-05 - A curated list of awesome Kubectl plugins.
