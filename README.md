...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,042 | 🐛 159 | 🌐 Go | 📅 2026-05-02.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 823 | 🐛 29 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-05-04 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,910 | 🐛 51 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,098 | 🐛 14 | 📅 2025-05-23 - A curated list of awesome Helm charts and resources.
