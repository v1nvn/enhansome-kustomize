...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 11,966 | 🐛 175 | 🌐 Go | 📅 2026-03-05.
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 38 | 🐛 5 | 🌐 Go | 📅 2026-03-09 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
