...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,020 | 🐛 170 | 🌐 Go | 📅 2026-04-08.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 819 | 🐛 27 | 🌐 Go | 📅 2026-04-13 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-04-12 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,852 | 🐛 53 | 🌐 Shell | 📅 2026-02-27 - A curated list of awesome Kubernetes resources.
