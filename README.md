...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,041 | 🐛 159 | 🌐 Go | 📅 2026-05-02.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 824 | 🐛 29 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,913 | 🐛 52 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
