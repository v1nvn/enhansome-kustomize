...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,010 | 🐛 168 | 🌐 Go | 📅 2026-04-03.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 818 | 🐛 43 | 🌐 Go | 📅 2026-04-03 - Generating Secrets from sops-encrypted files (Exec).
...
* [Secretize](https://github.com/bbl/secretize) ⭐ 71 | 🐛 6 | 🌐 Go | 📅 2025-07-15 - Generating Kubernetes Secret from various sources. It's like a swiss army knife, but for Kubernetes secrets (Exec).
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-04-05 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
* [PolicyGenerator](https://github.com/open-cluster-management-io/policy-generator-plugin) ⭐ 35 | 🐛 5 | 🌐 Go | 📅 2026-04-02 - Generating Open Cluster Management policies (Exec).
...
* [TemplateTransformer](https://github.com/joshdk/template-transformer) ⭐ 13 | 🐛 4 | 🌐 Go | 📅 2023-11-29 - Providing a set of KRM Functions to run builtin transformers in place (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,848 | 🐛 52 | 🌐 Shell | 📅 2026-02-27 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,095 | 🐛 10 | 📅 2025-05-23 - A curated list of awesome Helm charts and resources.
* [Awesome Kubectl plugins](https://github.com/ishantanu/awesome-kubectl-plugins) ⭐ 1,004 | 🐛 4 | 📅 2025-11-05 - A curated list of awesome Kubectl plugins.
