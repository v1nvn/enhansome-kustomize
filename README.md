...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 11,936 | 🐛 185 | 🌐 Go | 📅 2026-02-10.
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 37 | 🐛 3 | 🌐 Go | 📅 2026-02-11 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,804 | 🐛 74 | 🌐 Shell | 📅 2025-08-28 - A curated list of awesome Kubernetes resources.
