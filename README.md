...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 11,996 | 🐛 170 | 🌐 Go | 📅 2026-03-26.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 815 | 🐛 39 | 🌐 Go | 📅 2026-03-19 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 5 | 🌐 Go | 📅 2026-03-27 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,842 | 🐛 50 | 🌐 Shell | 📅 2026-02-27 - A curated list of awesome Kubernetes resources.
