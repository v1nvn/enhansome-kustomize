...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 11,972 | 🐛 177 | 🌐 Go | 📅 2026-03-05.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 809 | 🐛 38 | 🌐 Go | 📅 2026-03-09 - Generating Secrets from sops-encrypted files (Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 38 | 🐛 5 | 🌐 Go | 📅 2026-03-14 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
* [PolicyGenerator](https://github.com/open-cluster-management-io/policy-generator-plugin) ⭐ 35 | 🐛 4 | 🌐 Go | 📅 2026-03-13 - Generating Open Cluster Management policies (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,832 | 🐛 46 | 🌐 Shell | 📅 2026-02-27 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,091 | 🐛 8 | 📅 2025-05-23 - A curated list of awesome Helm charts and resources.
* [Awesome Kubectl plugins](https://github.com/ishantanu/awesome-kubectl-plugins) ⭐ 1,002 | 🐛 3 | 📅 2025-11-05 - A curated list of awesome Kubectl plugins.
