...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,034 | 🐛 175 | 🌐 Go | 📅 2026-04-17.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 820 | 🐛 28 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
