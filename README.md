...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,050 | 🐛 169 | 🌐 Go | 📅 2026-05-13.
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,939 | 🐛 58 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,098 | 🐛 4 | 📅 2026-05-16 - A curated list of awesome Helm charts and resources.
* [Awesome Kubectl plugins](https://github.com/ishantanu/awesome-kubectl-plugins) ⭐ 1,008 | 🐛 4 | 📅 2025-11-05 - A curated list of awesome Kubectl plugins.
