...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,050 | 🐛 168 | 🌐 Go | 📅 2026-05-13.
...
* [PolicyGenerator](https://github.com/open-cluster-management-io/policy-generator-plugin) ⭐ 35 | 🐛 6 | 🌐 Go | 📅 2026-05-15 - Generating Open Cluster Management policies (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,934 | 🐛 57 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
