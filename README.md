...
* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 835 | 🐛 30 | 🌐 Go | 📅 2026-04-14 - Generating Secrets from sops-encrypted files (Exec).
...
* [PolicyGenerator](https://github.com/open-cluster-management-io/policy-generator-plugin) ⭐ 35 | 🐛 6 | 🌐 Go | 📅 2026-06-03 - Generating Open Cluster Management policies (Exec).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,987 | 🐛 69 | 🌐 Shell | 📅 2026-04-28 - A curated list of awesome Kubernetes resources.
